...
g++ afrx.c -lboost_thread -lboost_system -lpthread 
    ...
    if (use_multiple_fanout_processes) {
        ...
        for (int cpu = 0; cpu < num_cpus; cpu++) {
            ...
            packet_receiver_thread_group.add_thread(
                new boost::thread(thread_attrs, boost::bind(start_af_packet_capture, "eno1", fanout_group_id))
            );
        }
        ...
        start_af_packet_capture("eno1", 0);
    }
